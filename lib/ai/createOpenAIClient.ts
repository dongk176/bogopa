...
export const OPENAI_TURN_JUDGMENT_MODEL =
  process.env.OPENAI_BOGOPA_TURN_JUDGMENT_MODEL || OPENAI_LABEL_MODEL;
export const OPENAI_TURN_ANALYSIS_MODEL =
  process.env.OPENAI_BOGOPA_TURN_ANALYSIS_MODEL || OPENAI_LABEL_MODEL;
