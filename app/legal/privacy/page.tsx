    ...
    const sections: Array<{
        ...
        },
        {
            ...
            bullets: [
                ...
                "식별자: 서비스 사용자 ID, 로그인 제공자별 식별값, 기기/세션 식별에 필요한 기술적 식별자",
                ...
                "사용 데이터: 출석체크 기록, 기능 이용 이력, 기억 잔액/변동 내역, 서비스 내 행동 로그",
                "진단 정보: 오류 로그, 성능 지표, 안정성 점검을 위한 기술 정보",
                "방문 기록: 앱/웹 내 화면 접근 이력, 접속 시간, 사용자 에이전트, 쿠키·세션·로컬스토리지 등 서비스 운영에 필요한 기술 정보",
            ],
        },
        {
            title: "3. 개인정보 수집 방법",
        ...
        },
        {
            ...
            bullets: [
                "사용자를 추적하는 데 사용되는 데이터: 방문 기록",
                "사용자에게 연결된 데이터: 사용자 콘텐츠, 진단, 연락처 정보, 구입 항목, 사용 데이터, 식별자",
                "사용자에게 연결되지 않은 데이터: 방문 기록, 진단, 사용자 콘텐츠 일부(통계·분석 목적의 비식별 처리 데이터)",
                "추적 관련 처리는 관련 법령 및 플랫폼 정책(예: ATT 정책)에 따라 필요한 고지·동의 절차를 준수합니다.",
            ],
        },
        {
            title: "15. 고지 의무",
