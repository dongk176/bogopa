...
export default function SignupCompleteModal() {
  ...
  return (
    ...
    >
      <div
        className={`w-full max-w-sm rounded-[2.5rem] border border-white/10 bg-[#1e221d] px-6 pb-8 pt-8 text-center shadow-[0_20px_60px_rgba(0,0,0,0.6)] transition-all duration-300 ${
      ...
      >
        ...
        >
          <h2 className="font-headline text-2xl font-bold tracking-tight text-[#faf9f5]">환영합니다!</h2>
          <p className="text-sm font-medium text-[#afb3ac] leading-relaxed">
            <span className="inline-flex flex-wrap items-center justify-center gap-x-1 gap-y-0 align-middle">
              <span>가입 축하 선물로</span>
              <span className="inline-flex items-center gap-1 text-[#bfe4f5]">
          ...
          <p className="text-sm font-medium text-[#afb3ac]">기억으로는 내 기억 생성과 대화를 이어나갈 수 있습니다.</p>
        </div>
